...
def generate_launch_description():
    ...
    attitude_status_config = config_dir + "/config/hitl/attitude_status.yaml"
    set_attitude_config = config_dir + "/config/hitl/set_attitude.yaml"
    map_tf_publisher_config = config_dir + "/config/hitl/map_tf_publisher.yaml"
